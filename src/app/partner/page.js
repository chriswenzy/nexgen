            ...
            <Row className="justify-content-center mb-5">
              <Col lg={8} className="text-center">
                <h2 className="display-5 fw-bold mb-3">
                  Why Partner with{" "}
                  <span className="text-primary">Nexgen Paint</span>?
                </h2>
          ...
          <Container>
            <Row className="justify-content-center mb-4">
              <Col lg={8} className="text-center">
                <h2 className="display-5 fw-bold mb-3">
                  Partner-Approved{" "}
                  <span className="text-primary">Product Categories</span>
                </h2>
              </Col>
            </Row>
                  ...
                  <Card className="h-100 border-0 shadow-sm">
                    <CardBody className="p-4 text-center">
                      <div className="icon-wrapper bg-primary bg-opacity-10 rounded-circle p-3 mb-4 mx-auto">
                        {index === 0 && (
                          <BsBrush size={24} className="text-primary" />
                        )}
                        {index === 1 && (
                        ...
                        {index === 3 && (
                          <BsPalette size={24} className="text-primary" />
                        )}
                      </div>
